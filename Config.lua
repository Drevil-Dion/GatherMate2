...
options.args.display.args.filters.args.herbs = {
	...
	args = {
		...
		herblist = {
			...
			name = L["Herb Bushes"],
			type = "multiselect",
			values = function() return sortedFilter["Herb Gathering"] end,
			set = "SetState",
			get = "GetState",
			arg = "Herb Gathering",
		},
...
options.args.display.args.filters.args.mines = {
	...
	args = {
		...
		minelist = {
			...
			name = L["Mineral Veins"],
			type = "multiselect",
			values = function() return sortedFilter["Mining"] end,
			set = "SetState",
			get = "GetState",
			arg = "Mining",
		},
...
options.args.display.args.filters.args.fish = {
	...
	args = {
		...
		fishlist = {
			...
			values = function() return sortedFilter["Fishing"] end,
			set = "SetState",
			get = "GetState",
			arg = "Fishing",
		},
...
options.args.display.args.filters.args.gas = {
	...
	args = {
		...
		gaslist = {
			...
			type = "multiselect",
			values = function() return sortedFilter["Extract Gas"] end,
			set = "SetState",
			get = "GetState",
			arg = "Extract Gas",
		},
...
options.args.display.args.filters.args.treasure = {
	...
	args = {
		...
		gaslist = {
			...
			type = "multiselect",
			values = function() return sortedFilter["Treasure"] end,
			set = "SetState",
			get = "GetState",
			arg = "Treasure",
		},
...
options.args.display.args.filters.args.woodcutting = {
	...
	args = {
		...
		gaslist = {
			...
			type = "multiselect",
			values = function() return sortedFilter["Woodcutting"] end,
			set = "SetState",
			get = "GetState",
			arg = "Woodcutting",
		},
